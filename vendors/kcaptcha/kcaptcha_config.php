...
$credits = 'www.lescigales.org'; # if empty, HTTP_HOST will be shown
...
$foreground_color = array(hexdec('c1'), hexdec('9a'), hexdec('e1'));
$background_color = array(hexdec('f5'), hexdec('ee'), hexdec('fb'));
