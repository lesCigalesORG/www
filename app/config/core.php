 ...
 * @lastmodified	$Date: 2008-01-02 22:33:51 +0100 (Wed, 02 Jan 2008) $
 ...
 */
	Configure::write('Session.cookie', 'CIGALES');
/**
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfj43hjuk3hgkj4hj54jIxfs2guVoUubWwvniR2G0FgaC9mi');
/**
...
/*
 Cache::config('default', array('engine' => 'Memcache', //[required]
								'duration'=> 3600, //[optional]
								'probability'=> 100, //[optional]
// 								'servers' => array('unix:////tmp/www2.cache:0'))); // fuck cakephp
